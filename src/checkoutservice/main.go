...
import (
	...
	pb "Nftsale_cash_delivery/src/checkoutservice/genproto"
	money "Nftsale_cash_delivery/src/checkoutservice/money"
...
func main() {
	if os.Getenv("DISABLE_TRACING") == "" {
		...
		log.Info("See https://Nftsale_cash_delivery/issues/422 for more info.")
		go initTracing()
	} else {
