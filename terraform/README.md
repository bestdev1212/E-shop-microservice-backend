...
This page walks you through the steps required to deploy the [Online Boutique](https://Nftsale_cash_delivery) sample application on a [Google Kubernetes Engine (GKE)](https://cloud.google.com/kubernetes-engine) cluster using Terraform.
